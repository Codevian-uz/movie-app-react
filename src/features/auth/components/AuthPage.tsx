                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="space-y-1">
                            <FormLabel className="text-xs font-semibold tracking-wider text-slate-400 uppercase">
                              Username
                            </FormLabel>
                            <FormControl>
                            ...
                            <FormControl>
                              <div className="group relative">
                                ...
                                <Input
                                  ...
                                  placeholder="••••••••"
                                  className="h-11 border-slate-700 bg-slate-800/50 pr-10 pl-10 text-white placeholder:text-slate-600 focus:border-cyan-500/50 focus:ring-cyan-500/20"
                                />
                                <button
                                  type="button"
                                  onClick={() => {
